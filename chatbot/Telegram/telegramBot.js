...
bot.on("message", async (msg) => {
  ...
  if (msg.text == 'informacion') {
    ...
    let card = {
      ...
      image_url: "https://www.upt.edu.pe/upt/web/assets/img/blanco_color.png",
      subtitle: "Creado por Diego Porlles y Anthony Belizario",
      buttons: [{
        text: "Pagina de la UPT",
        url: "http://www.upt.edu.pe/upt/web/index.php"
      },],
    };
